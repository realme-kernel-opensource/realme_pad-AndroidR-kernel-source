...
ifeq ($(LQ_HIGH_TEMP_VERSION),true)
KERNEL_CONFIG_OVERRIDE_FACTORY := CONFIG_HIGH_TEMP_VERSION=y
endif

ifeq ($(LQ_COMPILE_FACTORY_VERSION),yes)
KERNEL_CONFIG_FACTORY_OVERRIDE := CONFIG_COMPILE_FACTORY_VERSION=y
endif
...
$(TARGET_KERNEL_CONFIG): $(KERNEL_MAKE_DEPENDENCIES)
	...
	$(hide) if [ "$(KERNEL_CONFIG_LCT_OVERRIDE)" == "yes" ]; then \
			...
			echo $(KERNEL_CONFIG_FACTORY_OVERRIDE) >> $(KERNEL_OUT)/.config; \
