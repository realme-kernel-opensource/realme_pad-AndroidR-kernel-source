...
#define NOTIFY_CHARGER_OVER_VOL			0
#define NOTIFY_BAT_OVER_TEMP			1
#define NOTIFY_CHGING_CURRENT			2
#define NOTIFY_BAT_OVER_VOL				3
#define NOTIFY_CHGING_OVERTIME			4
#define NOTIFY_BAT_LOW_TEMP				5
#define NOTIFY_USB_TEMP_OVER			6


#define NOTIFY_BAT_NOT_CONNECT			7
#define NOTIFY_BAT_FULL					8
#define NOTIFY_CHARGER_LOW_VOL			9
...
struct oplus_chg_operations {
	...
	void (*set_safe_charging_status)(void);
};
