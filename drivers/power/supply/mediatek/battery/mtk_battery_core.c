...
oplus_batt_data oplus_battery_id_vol[OPLUS_MAX_NUM] = {[0]={800000,1050000},[1]={1100000,1325000}};
...
/* EVEN,gudi@WT.BSP,2021/01/29,modify offset for battery prowerfile */
	...
	if(bat_id_num == OPLUS_ATL){
		sprintf(battery_name,"oplus-atl-4v45-%smah","6000");
		devinfo_info_set("battery","4.45v","ATL");
	}else if(bat_id_num == OPLUS_SDI){
		sprintf(battery_name,"oplus-sdi-4v45-%smah","6000");
