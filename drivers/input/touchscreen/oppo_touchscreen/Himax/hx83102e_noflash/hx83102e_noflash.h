/***************************************************
 * File:hx83102e_drivers_s4322.h
 * VENDOR_EDIT
 * Copyright(C) 2008-2012 OPPO Mobile Comm Corp., Ltd
 * Description:
 *             hx83102e s4322 driver
 * Version:1.0:
...
int hx_oppo_gesture_id[HX_GESUTRE_SZ] = {
...
struct chip_data_hx83102e {
    uint32_t *p_tp_fw;
    tp_dev tp_type;
    char   *test_limit_name;
    struct himax_proc_operations *syna_ops; /*hx83102e func provide to hx83102e common driver*/
