...
#define BTS_RAP_PULL_UP_R		22000 /* 22K, pull up resister */

#define BTS_TAP_OVER_CRITICAL_LOW	195652 /* base on 10K NTC temp
						 * default value -40 deg
						 */

#define BTS_RAP_PULL_UP_VOLTAGE		1800 /* 1.8V ,pull up voltage */

#define BTS_RAP_NTC_TABLE		8 /* default is NCP03XH103F05RL(10K) */
...
#define BTSMDPA_RAP_NTC_TABLE		8 /* default is NCP03WF104F05RL(100K) */
