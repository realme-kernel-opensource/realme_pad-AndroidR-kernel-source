...
extern unsigned int hi846_main_read_region(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
extern unsigned int hi846_sub_read_region(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
...
struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{HI846A_SENSOR_ID, 0x40, hi846_main_read_region},
	{HI846B_SENSOR_ID, 0x42, hi846_sub_read_region},
	{GC08A3A_SENSOR_ID, 0x22, gc08a3_main_read_region},
	{GC08A3B_SENSOR_ID, 0x62, gc08a3_sub_read_region},
