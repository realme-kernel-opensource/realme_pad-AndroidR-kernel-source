...
/*
 * CN3927VAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "CN3927VAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long CN3927VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int CN3927VAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int CN3927VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int CN3927VAF_GetFileName(unsigned char *pFileName)
{
