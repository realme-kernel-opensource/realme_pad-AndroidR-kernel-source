...
/*
 * FP5510EE4AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "FP5510EE4AF_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd5[2] = {(char)(0xF2), (char)(0xF0)};
...
/* ////////////////////////////////////////////////////////////// */
long FP5510EE4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int FP5510EE4AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int FP5510EE4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int FP5510EE4AF_GetFileName(unsigned char *pFileName)
{
