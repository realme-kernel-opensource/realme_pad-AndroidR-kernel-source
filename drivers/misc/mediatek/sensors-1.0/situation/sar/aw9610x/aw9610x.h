...
{
	{
		.curr_state = 0,
		.last_state = 0,
		.key_press = KEY_SARCS0,
		.key_release = KEY_SAR_RELEASECS0,
		.name = "sar0_pad0",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.key_press = KEY_SARCS1,
		.key_release = KEY_SAR_RELEASECS1,
		.name = "sar0_pad1",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.key_press = KEY_SARCS2,
		.key_release = KEY_SAR_RELEASECS2,
		.name = "sar0_pad2",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.key_press = KEY_SARCS3,
		.key_release = KEY_SAR_RELEASECS3,
		.name = "sar0_pad3",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.key_press = KEY_SARCS4,
		.key_release = KEY_SAR_RELEASECS4,
		.name = "sar0_pad4",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.key_press = KEY_SARCS5,
		.key_release = KEY_SAR_RELEASECS5,
		.name = "sar0_pad5",
	},
	{
		.curr_state = 0,
