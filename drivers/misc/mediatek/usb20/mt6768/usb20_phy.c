...
/*Yong.Liu@BSP.CHG.Basic, 2021/01/14, Modify for update USB phy parameters*/
...
void usb_phy_tuning(void)
{
	...
	/*xiaoyong.nan 2021.06.05  usb_phy_tuning start*/
	if (mtk_musb->is_host) {
	...
	/*xiaoyong.nan 2021.06.05  usb_phy_tuning end*/
