...
#include "hi846amipiraw_Sensor.h"

#define PFX "hi846_main_camera_sensor"
...
UINT32 HI846A_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
