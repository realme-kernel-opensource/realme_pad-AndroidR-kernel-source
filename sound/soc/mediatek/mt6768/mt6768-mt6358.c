...
#include "../../codecs/audio_info/smartpa-info.h"
...
static struct snd_soc_dai_link_component mtk_default[] = {
	{
		.name = "snd-soc-dummy",
...
static struct snd_soc_dai_link_component fs1894_prince[] = {
	{
		.name = "fs16xx.6-0044",
		.dai_name = "fs16xx-aif",
	},
...
static struct snd_soc_dai_link_component aw88194a_prince[] = {
	{
	...
	{
		.name = "aw881xx_smartpa.6-0036",
		.dai_name = "aw881xx-aif-6-36",
	},
	{
		.name = "aw881xx_smartpa.6-0037",
		.dai_name = "aw881xx-aif-6-37",
	},
};

static struct snd_soc_dai_link_component aw88394_prince[] = {
	{
		.name = "aw883xx_smartpa.6-0038",
		.dai_name = "aw883xx-aif-6-34",
	},
	{
		.name = "aw883xx_smartpa.6-0039",
		.dai_name = "aw883xx-aif-6-35",
	},
	{
		.name = "aw883xx_smartpa.6-0040",
		.dai_name = "aw883xx-aif-6-36",
	},
	{
		.name = "aw883xx_smartpa.6-0041",
...
static struct snd_soc_dai_link mt6768_mt6358_dai_links[] = {
	...
	},
	{
		...
		.cpu_dai_name = "I2S1",
		.codecs = mtk_default,
		.num_codecs = ARRAY_SIZE(mtk_default),
		.no_pcm = 1,
		.dpcm_playback = 1,
		.ignore_suspend = 1,
		.be_hw_params_fixup = mt6768_i2s_hw_params_fixup,
...
static int mt6768_mt6358_dev_probe(struct platform_device *pdev)
{
	...
	enum smartpa_type smartpa_type_enum;
	...
	smartpa_type_enum = get_smartpa_type();
	pr_info("%s() smartpa_type = %d\n", __func__, smartpa_type_enum);

	if (smartpa_type_enum == FS1894SU) {
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].codecs = fs1894_prince;
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].num_codecs = ARRAY_SIZE(fs1894_prince);
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].codecs = fs1894_prince;
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].num_codecs = ARRAY_SIZE(fs1894_prince);
	} else if (smartpa_type_enum == AW88194A) {
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].codecs = aw88194a_prince;
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].num_codecs = ARRAY_SIZE(aw88194a_prince);
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].codecs = aw88194a_prince;
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].num_codecs = ARRAY_SIZE(aw88194a_prince);
	} else if (smartpa_type_enum == AW88394) {
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].codecs = aw88394_prince;
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].num_codecs = ARRAY_SIZE(aw88394_prince);
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].codecs = aw88394_prince;
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].num_codecs = ARRAY_SIZE(aw88394_prince);
	}else {
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].codec_dai_name = "snd-soc-dummy-dai";
		mt6768_mt6358_dai_links[spk_out_dai_link_idx].codec_name = "snd-soc-dummy";
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].codec_dai_name = "snd-soc-dummy-dai";
		mt6768_mt6358_dai_links[spk_iv_dai_link_idx].codec_name = "snd-soc-dummy";
	}
